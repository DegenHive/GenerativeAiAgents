...
def generate_wake_up_hour(persona):
  ...
  Persona state: identity stable set, o_acc_nativeness,  
...
def generate_first_daily_plan(persona, wake_up_hour): 
  ...
  Persona state: identity stable set, o_acc_nativeness, cur_data_str,  
...
def generate_task_decomp(persona, task, duration): 
  ...
  Persona state: identity stable set, curr_date_str,  
...
def revise_identity(persona): 
  ...
  persona.scratch.daily_finances = new_daily_req
